...
public class Step02IfForTest extends PlainTestCase {
    ...
    public void test_iffor_refactor_foreach_to_forEach() {
        ...
        // done jflute 1on1にて、ちょこっと振り返り予定 (2025/08/11)
    }
    ...
    public void test_iffor_yourExercise() {
        ...
        // #1on1: Setという抽象的な概念(インターフェース)で取り扱っている意義について。
        // ArrayList, HashSetは、実現方法を意識したクラス。
        // それを利用する側のプログラムは、実現方法は別に気にしなくていいので、
        // 最低限のListとかSetという概念で取り扱っておきたい。
        // そうすると、実現方法を変えたいとき一箇所の修正で済む。
        // step6の先取りに。
        
        // #1on1: 質問: 配列(Array)とリストの用語に違いについて by tabataさん
        // 配列は、Javaの文法上組み込まれた複数の値を表現するプリミティブに近いオブジェクト!?
        // 研修でやったC言語の配列と思ってもらってOK。特徴としては、確保領域が固定長。
        //
        // リストは、まずは人間が思い浮かべてるだけの概念で、文法的に存在するわけじゃない。
        // 人間のとって都合の良い、可変長でadd()add()ほぼ無限にできるリストという概念。
        // その概念をクラスで実現している。その一つが ArrayList になる。
        //
        // ちなみに、配列はJavaの文法に組み込まれたものに対して、
        // ArrayListは標準で組み込まれてはいるけれども、(Javaの文法上で作られた)ただのクラス。
        // リストという概念を、Java自身がデフォルトで提供してくれているという感覚。
        //
        // ちなみにちなみに、ArrayListとLinkedListの実現方法の違いから発生する特徴の違いについて。
        // 実際には、ストレートなループを回すだけのことが多いので、ArrayListの利用頻度が圧倒的に多いけど...
        // 思考のプロトタイプとして、こういう風に一つの概念に実現方法が複数あるってことがある。
    }
