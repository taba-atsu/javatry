...
public class Step06ObjectOrientedTest extends PlainTestCase {
    ...
    // done jflute 次回1on1にて、Zombie話で盛り上がろう (2026/01/07)
    /**
    ...
    public void test_objectOriented_zoo() {
        ...
        // _/_/_/_/_/_/_/_/_/_/
        // #1on1: コード実務面の話と、業務意味合い的な話と両方書いてくれてGood (2026/02/18)
        // 業務意味合い思考トレーニング。Animalの上にもういっこ概念作って、そこから分岐させる。by たばたさん
        // 良い発想です。生き物？動くもの？何かしらの概念で枝分かれ。
        // 動物とゾンビで共通的なものは、その「生き物？動くもの？」のところに入れる。
        // バイオハザードの世界観の例: たばたさん自ら状態という言葉を出したの素晴らしい。
        // ゾンビ王国のゾンビ王子の例: もはや種族と捉えても良いのであれば今の実装でもいいかも。
        //
        // 業務概念次第。
        // その業務概念と合わない実装をすると、コード上で無理が出てくる。
        // だから、業務概念を正しく捉えることが非常に大事。
        // 業務理解力がコーディング力に直結する。
        //
        // 感動してくれてありがとう(^^。
    }
